            ...
            <div className="full-body-parts">
              <Sidebar/>
                <main className="d-block ms-lg-auto content-parts d-block">
                    <Navbar/>
                    <div className="home-settings float-start w-100 mb-4">
                        <div className='calendar-tab'>
                            <h2 className='mb-4 all-page-heading'> Dashboard </h2>

                                <div className='row  gy-5'>
                                    <div className='col-lg-8 '>
                                       <div className='main-white-bg bg-white inside-div-col w-100'> 
                                            <div className='performance-container'>
                                                <div className='heading-automation'>
                                                    <h2 className='headtitle'>Performance</h2>
                                                    <div className='row row-cols-1 row-cols-lg-4 selectTag mb-4'>
                                                        <div className='col'>
                                                        ...
                                                        <div className='col'>
                                                            <input type="date" className="performance-select form-control" />
                                                        </div>
                                                ...
                                                <div className='row row-cols-1 row-cols-lg-4'>
                                                        <div className='col'>
                                                            <div className='comon-applointes d-inline-block w-100'>
                                                        ...
                                                        <div className='col'>
                                                            <div className='comon-applointes d-inline-block w-100'>
                                                                <div className='performance-sub-heading performance-sub-row w-100'>
                                                                    <p className='sub-heading-number'>2 <sup className='sub-number' >-33%</sup> <span className='infoIcon' >  <IoIosInformationCircle /> </span> </p>
                                                                    <p className='sub-heading-appointments'>Sales Revenue</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className='col'>
                                                            <div className='comon-applointes d-inline-block w-100'>
                                                                <div className='performance-sub-heading performance-sub-row w-100'>
                                                                    <p className='sub-heading-number'>2 <sup className='sub-number' >-33%</sup> <span className='infoIcon' >  <IoIosInformationCircle /> </span> </p>
                                                                    <p className='sub-heading-appointments'>Hours Worked</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className='col'>
                                                            <div className='comon-applointes d-inline-block w-100'>
                                                                <div className='performance-sub-heading performance-sub-row w-100'>
                                                                    <p className='sub-heading-number'>2 <sup className='sub-number' >-33%</sup> <span className='infoIcon' >  <IoIosInformationCircle /> </span> </p>
                                                                    <p className='sub-heading-appointments'>New Customers</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                </div>
                                       ...
                                       <div className='main-white-bg bg-white inside-div-col w-100'>
                                            <div className='performance-container'>
                                                <div className='heading-automation'>
                                                    ...
                                                    <div className='row row-cols-1 gy-3 selectTag'>
                                                        <div className='col'>
                                                              <select name="location_id" className="performance-select form-select">
                                                                <option value="">All locations</option>
                                                                <option value="1">Main Location</option>
                                                    ...
                                                    <div className='upcomming-buttom text-center uplocming-div d-inline-block w-100'>
                                                        <RiImportLine className='import-icon' />
                                                        <p>No Upcoming Appointments</p>
                                                        <button type='button' className='btn addAppointment'><FaPlus />Add Appointment</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className='performance-container'>
                                                    <div className='heading-automation'>
                                                        ...
                                                        <div className='row justify-content-between align-content-center'>
                                                            <div className='col-lg-6'>
                                                                <div className='row row-cols-1 row-cols-lg-3'>
                                                                      <div className='col'>
                                                                          <input type="date" className="form-control performance-select" />
                                                                      </div>
                                                                      <div className='col'>
                                                                         <select name="location_id" className="form-select performance-select">
                                                                            <option value="">All locations</option>
                                                                            <option value="1">Main Location</option>
                                                                            <option value="2">Home</option>
                                                                            <option value="3">Hospital</option>
                                                                      ...
                                                                      <div className='col'>
                                                                            <select name="agent_id" id="" className="form-select performance-select">
                                                                                <option value="">All Agents</option>
                                                                                <option value="1">Lynn Nicely</option>
                                                                                <option value="2">Sara Brooks</option>
                                                                                <option value="3">tommy lasso</option>
                                                            ...
                                                            <div className='col-lg-5'>
                                                                <ul className="nav nav-tabs next-btn120 justify-content-end" id="myTab" role="tablist">
                                                        ...
                                                        <div className="tab-content pt-4" id="myTabContent">
                                                            ...
                                                            <div className="tab-pane fade pt-4" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                                <CalendarMain />
                                                            </div>
