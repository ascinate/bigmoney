                ...
                <div className="accordion" id="accordionExample">
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                <ul>
                                    ...
                                    <li> <Link href="/services"> Bundles </Link> </li> 
                                    <li> <Link href="/services"> Categories </Link> </li>
                                    <li> <Link href="/services"> Service Extras </Link> </li> 
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                <ul>
                                    ...
                                    <li> <Link href="/location"> Bundles </Link> </li> 
                                    <li> <Link href="/location"> Categories </Link> </li>
                                    <li> <Link href="/location"> Service Extras </Link> </li> 
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapsefourt" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                <ul>
                                    ...
                                    <li> <Link href="/integrations"> Calendars </Link> </li> 
                                    <li> <Link href="/integrations"> Meetings </Link> </li>
                                    <li> <Link href="/integrations"> Marketing </Link> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapsefour" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                <ul>
                                    ...
                                    <li> <Link href="/formfields"> Customer Fields </Link> </li> 
                                    <li> <Link href="/formfields"> Booking Fields </Link> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type='button' className='btn side-btn' onClick={handleClick}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.47365 11.7183C8.11707 12.0749 8.11707 12.6531 8.47365 13.0097L12.071 16.607C12.4615 16.9975 12.4615 17.6305 12.071 18.021C11.6805 18.4115 11.0475 18.4115 10.657 18.021L5.83009 13.1941C5.37164 12.7356 5.37164 11.9924 5.83009 11.5339L10.657 6.707C11.0475 6.31653 11.6805 6.31653 12.071 6.707C12.4615 7.09747 12.4615 7.73053 12.071 8.121L8.47365 11.7183Z" fillOpacity="0.9"></path>
                                <path d="M14.3584 11.8336C14.0654 12.1266 14.0654 12.6014 14.3584 12.8944L18.071 16.607C18.4615 16.9975 18.4615 17.6305 18.071 18.021C17.6805 18.4115 17.0475 18.4115 16.657 18.021L11.6819 13.0459C11.3053 12.6693 11.3053 12.0587 11.6819 11.6821L16.657 6.707C17.0475 6.31653 17.6805 6.31653 18.071 6.707C18.4615 7.09747 18.4615 7.73053 18.071 8.121L14.3584 11.8336Z" fillOpacity="0.4"></path>
                            </svg>
                    </button>
