                        ...
                        <div key={div.id}>
                            <div className='tax-section-row-one' onClick={() => handleToggle(div.id)}>
                                <div className='tax-section-row-one-left d-flex align-items-center'>
                                    ...
                                    <div>
                                        <span className='putnamcounty'>New Workflow</span>
                                    </div>
                                </div>
                                <button
                                    onClick={(e) => {
                                    ...
                                    <div className='add-workflow-toggle'>
                                        ...
                                        <div className='toggle-border-bottom' >
                                            <div className='tax-section-toggle-row-one d-flex align-items-center'>
                                                ...
                                                <div className='tax-section-tax-input-div w-100 border-left-toggle'>
                                                    <input type="text" placeholder='name' className='form-control' value={inputName} onChange={(e) => setInputname(e.target.value)} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className='toggle-border-bottom' >
                                        ...
                                        <div className='toggle-border-bottom' >
                                            <div className='tax-section-toggle-row-one d-flex align-items-center'>
                                                ...
                                                <div className='tax-section-tax-input-div w-100 border-left-toggle'>
                                                    <div className="form-check form-switch" onClick={hadnleConditionalToggle}>
                                                        <input className="form-check-input" type="checkbox" id="flexSwitchCheckChecked" />
                                                        <label className="form-check-label" for="flexSwitchCheckChecked">Trigger only when specific conditions are met</label>
                                        ...
                                        <div className='toggle-border-bottom' >
                                            <div className='tax-section-toggle-row-one d-flex align-items-center'>
                                                ...
                                                <div className='tax-section-tax-input-div w-100 border-left-toggle'>
                                                    <div className="form-check form-switch" onClick={hadnleTimeOffset}>
                                                        <input className="form-check-input" type="checkbox" id="flexSwitchCheckChecked" />
                                                        <label className="form-check-label" for="flexSwitchCheckChecked">Execute actions with a time offset</label>
                                        ...
                                        <div className='toggle-border-bottom' >
                                            <div className='tax-section-toggle-row-one d-flex align-items-center'>
                                                ...
                                                <div className='tax-section-tax-input-div w-100 border-left-toggle'>
                                                    <button type="text" placeholder='name' className='form-control'><FaPlus /> Add Action</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='toggle-border-bottom' >
                                            <div className='tax-section-toggle-row-one d-flex justify-content-between align-items-center'>
                                                    ...
                                                    <div cla>
                                                    <button className='test-this-workflow-btn'><MdOutlinePlayCircle />Test this workflow</button>
                                                    <button type="text" placeholder='name' className='automation-save-workflow-btn'> Save Workflow</button>
